...
useRouteMatch is used to get access tot he match object and create relative paths for URLs.

1. How would you explain form validation to someone who has never programmed before?

Form validation is what makes sure you type in the correct information in the correct boxes

1. In 1-2 sentences, define end to end testing.

end to end testing is testing what the user experience should be.
